...
// [port] 91 entries: cos(0°) through cos(90°). Binary search uses lowerIdx=91,
// so index 90 must be valid. On N64 the adjacent word was zero (= cos 90°).
f32 sLookupTableAcosDegrees[91] = {
