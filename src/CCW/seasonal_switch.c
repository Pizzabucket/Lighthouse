...
void func_80389268(Actor *this) {
    ...
    case 1:
        if (levelSpecificFlags_get(this->unk10_12 + 7)) {
            timedFunc_set_1(0.05f, (GenFunction_1)func_803891B0, (uintptr_t)this->marker);
            timedFunc_set_1(4.0f, (GenFunction_1)func_8038921C, (uintptr_t)this->marker);
