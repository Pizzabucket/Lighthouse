...
void func_80387F64(Actor *this, s32 next_state){
    ...
    if (next_state == 2) {
        ...
        if (local->unk0->unkA != 0) {
            ...
            timedFunc_set_2(7.0f, (GenFunction_2)func_80387F38, (uintptr_t)this->marker, 3);
        }
    }
...
void func_80388478(Actor *this) {
    ...
    if (!this->volatile_initialized) {
        ...
        if (!fileProgressFlag_get(FILEPROG_E3_CCW_FLOWER_SPRING) && (gsworld_getMap() != MAP_43_CCW_SPRING)) {
