...
void func_8038B6DC(ActorMarker *marker) {
    ...
    for(i = 0; i < 3; i++){
        skeletalAnim_setCallback_1(this->unk148, phi_f20, (GenFunction_1)func_8038B610, (uintptr_t)this->marker);
        phi_f20 += randf2(0.15f, 0.3f);
        if(0.85 < phi_f20)
            break;
    }
    skeletalAnim_setCallback_1(this->unk148, 0.35f, (GenFunction_1)func_8038B4C0, (uintptr_t)this->marker);
    skeletalAnim_setCallback_1(this->unk148, 0.63f, (GenFunction_1)func_8038B58C, (uintptr_t)this->marker);
    skeletalAnim_setCallback_1(this->unk148, 0.9f, (GenFunction_1)func_8038B6DC, (uintptr_t)this->marker);
}
