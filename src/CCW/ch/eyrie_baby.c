...
void func_803897B8(Actor *this, s32 next_state) {
    ...
    if (next_state == 4) {
        ...
        skeletalAnim_setBehavior(this->unk148, SKELETAL_ANIM_1_LOOP);
        skeletalAnim_setCallback_1(this->unk148, 0.2f, (GenFunction_1)func_80389740, (uintptr_t)this->marker);
        skeletalAnim_setCallback_1(this->unk148, 0.3f, (GenFunction_1)func_80389740, (uintptr_t)this->marker);
        skeletalAnim_setCallback_1(this->unk148, 0.4f, (GenFunction_1)func_80389740, (uintptr_t)this->marker);
        skeletalAnim_setCallback_1(this->unk148, 0.72f, (GenFunction_1)func_80389740, (uintptr_t)this->marker);
        skeletalAnim_setCallback_1(this->unk148, 0.82f, (GenFunction_1)func_80389740, (uintptr_t)this->marker);
        skeletalAnim_setCallback_1(this->unk148, 0.92f, (GenFunction_1)func_80389740, (uintptr_t)this->marker);
