...
void CCW_func_8038868C(Actor *this, s32 next_state) {
    ...
    if (next_state == 2) {
        ...
        timedFunc_set_2(3.2f, (GenFunction_2) CCW_func_80388660, (uintptr_t)this->marker, 3);
    }
    if (next_state == 3) {
        func_803883F4();
    }
...
void func_8038894C(ActorMarker* marker, ActorMarker *other_marker) {
    ...
    if (actor->state == 1) {
        ...
        timedFunc_set_2(0.5f, (GenFunction_2)CCW_func_80388660, (uintptr_t)actor->marker, 2);
    }
}
