...
void func_8034FDA0(s32 arg0) {
    ...
    if (D_80386150.unkC == D_80386150.unk10) {
        sp34 = ((uintptr_t)D_80386150.unkC - (uintptr_t)D_80386150.unk8)/0x30;
        sp24 = sp34 * 2;
...
void func_80350174(void) {
    ...
    D_80386150.unk10 = (Struct_core2_C89C0_1 *)((uintptr_t)D_80386150.unk8 + 0x60);
    D_80386150.unk14 = bk_malloc(2*sizeof(Struct_core2_C89C0_0));
    D_80386150.unk18 = D_80386150.unk14;
    D_80386150.unk1C = (Struct_core2_C89C0_0 *)((uintptr_t)D_80386150.unk14 + 2*sizeof(Struct_core2_C89C0_0));
    for(i = 0x31; i < 0x36; i++){
...
void func_803506DC(void){
    uintptr_t sp1C = (uintptr_t)D_80386150.unk8; // [port] pointer-width for defrag relocation
    uintptr_t sp18 = (uintptr_t)D_80386150.unk14;
    D_80386150.unk8 = (Struct_core2_C89C0_1 *)defrag((void *)sp1C);
    D_80386150.unkC = (Struct_core2_C89C0_1 *)(((uintptr_t)D_80386150.unkC - sp1C) + (uintptr_t)D_80386150.unk8);
    D_80386150.unk10 = (Struct_core2_C89C0_1 *)(((uintptr_t)D_80386150.unk10 - sp1C) + (uintptr_t)D_80386150.unk8);
    D_80386150.unk14 = (Struct_core2_C89C0_0 *)defrag((void *)sp18);
    D_80386150.unk18 = (Struct_core2_C89C0_0 *)(((uintptr_t)D_80386150.unk18 - sp18) + (uintptr_t)D_80386150.unk14);
    D_80386150.unk1C = (Struct_core2_C89C0_0 *)(((uintptr_t)D_80386150.unk1C - sp18) + (uintptr_t)D_80386150.unk14);
}
