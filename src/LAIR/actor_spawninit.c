...
void func_80387E94(uintptr_t arg0)
{
    ActorMarker *marker;
    Actor *actor1;
    Actor *actorNew;
...
void func_803880BC(Actor *this)
{
    ...
    if (!this->volatile_initialized)
    {
        ...
        __spawnQueue_add_1((GenFunction_1)func_80387E94, (uintptr_t)this->marker);
...
void func_803897D4(uintptr_t arg0)
{
...
void func_8038982C(Actor *this)
{
    if (!this->initialized)
    {
        ...
        if (!fileProgressFlag_get(FILEPROG_9E_CRYPT_COFFIN_LID_OPEN))
            __spawnQueue_add_1((GenFunction_1)func_803897D4, (uintptr_t)this->marker);
    }
}
