...
ParticleEmitter * partEmitMgr_defragEmitter(ParticleEmitter *this){
    ...
    if(this){
        ...
        this->pList_start_124 = (Particle *)((uintptr_t)this + (uintptr_t)((uintptr_t)this->pList_start_124 - a3));
        this->pList_end_128 = (Particle *)((uintptr_t)this + (uintptr_t)((uintptr_t)this->pList_end_128 - a3));
        this->pList_capacity_12C = (Particle *)((uintptr_t)this + (uintptr_t)((uintptr_t)this->pList_capacity_12C - a3));
        if(i < partEmitMgrLength){
            partEmitMgr[i] = this;
        }
