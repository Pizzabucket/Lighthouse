...
void func_80305CD8(s32 idx, s32 count){
    if(sProp2TotalCounts != NULL && (idx >= 0) && (idx < D_8036ABA8)){ // [port] NULL guard for spawn-before-init ordering
