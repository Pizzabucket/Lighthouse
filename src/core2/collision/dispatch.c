...
typedef BKCollisionTriangle * (*Method_Core2_999A0_0)(f32[3], f32[3], f32[3], u32);
typedef BKCollisionTriangle * (*Method_Core2_999A0_1)(f32[3], f32[3], f32, f32[3], s32, u32);
typedef BKCollisionTriangle * (*Method_Core2_999A0_2)(f32[3], f32, f32[3], u32);
...
BKCollisionTriangle *func_80320B98(f32 arg0[3], f32 arg1[3], f32 arg2[3], u32 flags) {
...
BKCollisionTriangle *func_80320C94(f32 arg0[3], f32 arg1[3], f32 arg2, f32 arg3[3], s32 arg4, u32 arg5) {
    Struct_core2_999A0_0 *var_s0;
    BKCollisionTriangle * temp_v0_2;
    BKCollisionTriangle * var_s7;
...
BKCollisionTriangle *func_80320DB0(f32 arg0[3], f32 arg1, f32 arg2[3], u32 arg3) {
    Struct_core2_999A0_0 *var_s0;
    BKCollisionTriangle * temp_v0_2;
    BKCollisionTriangle * var_s7;
