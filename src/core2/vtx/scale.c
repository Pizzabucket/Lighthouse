...
void func_8034EC50(s32 arg0, BKModelVtxRef *ref, Vtx *dst, void *arg3) {
    ...
    tmp0 = data->unk4;
    tmp1 = data->unk8;
    tmp0 += (dst->v.ob[0] - data->unk10)*200.0f;
    tmp1 += (dst->v.ob[2] - data->unk14)*200.0f;
    temp_f2 = (sinf(tmp0) + cosf(tmp1)) * data->unk20;
    dst->v.ob[1] = data->unkC + temp_f2;
    temp_f16 = (s32) (((temp_f2 / data->unk24) * 50.0f) + 205.0f);
    dst->v.cn[0] = (s32)(ref->v.v.cn[0] * temp_f16) / 255;
    dst->v.cn[1] = (s32)(ref->v.v.cn[1] * temp_f16) / 255;
    dst->v.cn[2] = (s32)(ref->v.v.cn[2] * temp_f16) / 255;
    dst->v.tc[0] = ref->v.v.tc[0] + data->unk28[0];
    dst->v.tc[1] = ref->v.v.tc[1] + data->unk28[1];
}
