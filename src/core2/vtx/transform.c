...
void func_8034C3D0(BKModel *arg0, s32 arg1, s32 vtx_xform_id, s32 arg3){
    ...
    v0->model = arg0;
    v0->unk4 = arg1;
    if ((u32)v0->xform_id < sizeof(D_80372030)/sizeof(D_80372030[0])) {
        D_80372030[v0->xform_id].unk0(&v0->unk8, arg3, v0->model, v0->unk4);
    } else {
        BK_LOG_WARN("[func_8034C3D0] xform_id out of bounds");
    }
}
...
BKModel *func_8034C4F0(Struct70s *arg0) {
    struct1Ds *parent = (struct1Ds *)((u8 *)arg0 - offsetof(struct1Ds, unk8));
    return parent->model;
}
...
void func_8034C97C(void){
    D_80386140.unk4 = bk_vector_new(sizeof(struct1Ds), 0x10);
    func_8034C9B0(1);
}
