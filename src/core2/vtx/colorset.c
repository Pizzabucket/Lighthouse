...
/* .code */
void func_8034CA80(s32 arg0, BKModelVtxRef *arg1, Vtx *arg2, void *arg3){
    Struct6Fs *data = (Struct6Fs *)arg3;
    s32 i;
    for(i = 0; i < 3; i++){
        arg2->v.cn[i] = arg1->v.v.cn[i]*data->unk0;
    }
}
...
void func_8034CB9C(Struct6Fs *arg0, BKModel *model, s32 mesh_id) {
    ...
    model_transformMesh(model, mesh_id, func_8034CA80, (void *) arg0);
}
