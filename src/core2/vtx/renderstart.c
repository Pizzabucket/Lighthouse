...
/* .code */
void func_8034D240(s32 mesh_id, BKModelVtxRef *src, Vtx *dst, void *arg3) {
    Struct6Ds *data = (Struct6Ds *)arg3;
    f32 temp_f0;

    temp_f0 = data->unk70 / data->unk74;
    dst->v.cn[0] = (data->unk50[0] + temp_f0 * (data->unk60[0] - data->unk50[0])) * src->v.v.cn[0];
    dst->v.cn[1] = (data->unk50[1] + temp_f0 * (data->unk60[1] - data->unk50[1])) * src->v.v.cn[1];
    dst->v.cn[2] = (data->unk50[2] + temp_f0 * (data->unk60[2] - data->unk50[2])) * src->v.v.cn[2];
    dst->v.cn[3] = (data->unk50[3] + temp_f0 * (data->unk60[3] - data->unk50[3])) * src->v.v.cn[3];
}

void func_8034D554(s32 mesh_id, BKModelVtxRef *src, Vtx *dst, void *arg3){
    Struct6Ds *data = (Struct6Ds *)arg3;
    f32 temp_f0;
    f32 sp18[3];

    temp_f0 = data->unk44 / data->unk48;
    temp_f0 = temp_f0 * temp_f0 * temp_f0 * temp_f0;
    ml_vec3f_interpolate_fast(sp18, data->unk2C, data->unk38, temp_f0);
    dst->v.ob[0] = (s16)(src->v.v.ob[0] + sp18[0]);
    dst->v.ob[1] = (s16)(src->v.v.ob[1] + sp18[1]);
    dst->v.ob[2] = (s16)(src->v.v.ob[2] + sp18[2]);
}

void func_8034D634(s32 mesh_id, BKModelVtxRef *src, Vtx *dst, void *arg3){
    Struct6Ds *data = (Struct6Ds *)arg3;
    f32 temp_f0;
    f32 sp18[3];
...
void func_8034D700(s32 mesh_id, BKModelVtxRef *src, Vtx *dst, void *arg3){
    Struct6Ds *data = (Struct6Ds *)arg3;
...
void func_8034D740(s32 mesh_id, BKModelVtxRef *src, Vtx *dst, void *arg3){
    Struct6Ds *data = (Struct6Ds *)arg3;
    f32 temp_f0;
    f32 temp_f12;
    f32 temp_f14;
    ...
    temp_f0 = data->unk98 / data->unk9C;
    dst->v.cn[0] = (data->unk78[0] + ((data->unk88[0] - data->unk78[0]) * temp_f0));
    dst->v.cn[1] = (data->unk78[1] + ((data->unk88[1] - data->unk78[1]) * temp_f0));
    dst->v.cn[2] = (data->unk78[2] + ((data->unk88[2] - data->unk78[2]) * temp_f0));
    dst->v.cn[3] = (((data->unk94 - data->unk84) * temp_f0) + data->unk84);
}

void func_8034D9C8(s32 mesh_id, BKModelVtxRef *src, Vtx *dst, void *arg3) {
    Struct6Ds *data = (Struct6Ds *)arg3;
    f32 temp_f0;
...
void func_8034DA7C(s32 mesh_id, BKModelVtxRef *src, Vtx *dst, void *arg3)  {
    Struct6Ds *data = (Struct6Ds *)arg3;
    f32 sp24[3];
    f32 sp18[3];

    sp24[0] = (f32) (data->unk14[0] + data->unk1A[0]);
    sp24[1] = (f32) (data->unk14[1] + data->unk1A[1]);
    sp24[2] = (f32) (data->unk14[2] + data->unk1A[2]);
    sp24[0] /= 2;
    sp24[1] /= 2;
    sp24[2] /= 2;
    ...
    sp18[2] = 0.0f;
    ml_vec3f_roll_rotate_copy(sp18, sp18, data->unk4 + ((data->unk44 / data->unk48) * (data->unk8 - data->unk4)));
...
void func_8034DD74(Struct6Ds *arg0, s32 arg1, BKModel *model, s32 mesh_id) {
    ...
    arg0->unk44 = 0.0f;
    arg0->unk48 = 0.0f;
    model_getMeshCoordRange(model, mesh_id, arg0->unk14, arg0->unk1A);
}
...
void func_8034E26C(Struct6Ds *arg0, BKModel *model, s32 mesh_id) {
    ...
    if (arg0->unk74 > 0.0f) {
        ...
        model_transformMesh(model, mesh_id, func_8034D240, (void *) arg0);
        if (arg0->unk28 != 0) {
            arg0->unk28--;
            if (arg0->unk28 == 0) {
                arg0->unk74 = 0.0f;
    ...
    if (arg0->unk9C > 0.0f) {
        ...
        if (arg0->unk29 == 5) {
            model_transformMesh(model, mesh_id, func_8034D9C8, (void *) arg0);
        } else {
            model_transformMesh(model, mesh_id, func_8034D740, (void *) arg0);
        }
    ...
    switch (arg0->unk29) {
        case 1:
            model_transformMesh(model, mesh_id, func_8034D554, (void *) arg0);
            break;
        case 2:
            model_transformMesh(model, mesh_id, func_8034D634, (void *) arg0);
            break;
        case 3:
            model_transformMesh(model, mesh_id, func_8034D700, (void *) arg0);
            break;
        case 4:
            model_transformMesh(model, mesh_id, func_8034DA7C, (void *) arg0);
            break;
    }
    if (arg0->unk48 <= arg0->unk44) {
        arg0->unk29 = 0;
