            ...
            for(var_s5 = 0; var_s5 < D_8037E900->unk10; var_s5++) {
                ...
                if (D_8037E900->unk4[var_s5].font_bin != NULL) {
                    ...
                    for(i_chunk = 0; i_chunk < chunk_count; i_chunk++){
                        D_8037E900->unk4[var_s5].letter_texture[i_chunk] = (void*)(((uintptr_t)D_8037E900->unk4[var_s5].letter_texture[i_chunk] - (uintptr_t)prev_sprite_ptr) + (uintptr_t)D_8037E900->unk4[var_s5].font_bin);
                    }
                }
            }
            // #endregion
