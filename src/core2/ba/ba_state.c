...
bsMap D_80363824[] ={
    ...
    {BS_CROC_OW, bscroc_die_init, bscroc_die_update, bscroc_die_end, func_80296590},
    ...
    {0x00000077, bsswim_lookat_init, bsswim_lookat_update, bsswim_lookat_end, func_80296608},
    {0x00000078, bsbswim_lookat_init, bsbswim_lookat_update, bsbswim_lookat_end, func_80296608},
