...
extern ActorInfo gChPresentBlue;
extern ActorInfo gChPresentGreen;
extern ActorInfo gChPresentRed;
extern ActorInfo gChWozza;
extern ActorInfo gWozzaJiggy;
extern ActorInfo gChBoggyHome;
extern ActorInfo D_803926C0;
extern ActorInfo gChWozzaCave;
...
void FP_func_80391324(void)
{
      ...
      spawnableActorList_add(&gChPresentBlue, actor_new, ACTOR_FLAG_UNKNOWN_3);
      spawnableActorList_add(&gChPresentGreen, actor_new, ACTOR_FLAG_UNKNOWN_3);
      spawnableActorList_add(&gChPresentRed, actor_new, ACTOR_FLAG_UNKNOWN_3);
      ...
      spawnableActorList_add(&gChWozza, actor_new, ACTOR_FLAG_UNKNOWN_3 | ACTOR_FLAG_UNKNOWN_8 | ACTOR_FLAG_UNKNOWN_19);
      spawnableActorList_add(&gWozzaJiggy, actor_new, ACTOR_FLAG_UNKNOWN_2 | ACTOR_FLAG_UNKNOWN_6);
      spawnableActorList_add(&gChBoggyHome, actor_new, ACTOR_FLAG_UNKNOWN_3 | ACTOR_FLAG_UNKNOWN_5 | ACTOR_FLAG_UNKNOWN_7);
      spawnableActorList_add(&D_803926C0, actor_new, ACTOR_FLAG_UNKNOWN_10 | ACTOR_FLAG_UNKNOWN_27);
      spawnableActorList_add(&gChWozzaCave, actor_new, ACTOR_FLAG_UNKNOWN_3 | ACTOR_FLAG_UNKNOWN_8);
