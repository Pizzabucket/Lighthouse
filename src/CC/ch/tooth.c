...
ActorInfo D_80389B90 = {
    MARKER_4E_CLANKER_TOKEN_TOOTH, ACTOR_101_CLANKER_TOKEN_TOOTH, ASSET_891_MODEL_CLANKER_TOKEN_TOOTH_OPEN, 
    0, NULL, 
...
ActorInfo D_80389BB4 = {
    MARKER_4F_CLANKER_JIGGY_TOOTH, ACTOR_102_CLANKER_JIGGY_TOOTH, ASSET_893_MODEL_CLANKER_JIGGY_TOOTH_OPEN, 
    0, NULL, 
    chTooth_update, actor_update_func_80326224, actor_draw, 
    0, 0, 0.0f, 0
};
