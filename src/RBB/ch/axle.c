...
ActorLocal_RBB_2A70_0 D_80390430[] = {
    {ACTOR_178_RBB_SPINNING_FLAT_PLATFORM_1, {0.0f,     -60.0f, 2450.0f},   0.0f, 6.0f, {     0.0f, -100.0f,  1900.0f}},
    {ACTOR_179_RBB_SPINNING_FLAT_PLATFORM_2, {-1600.0f, 730.0f, -700.0f}, 270.0f, 6.0f, { -1600.0f,  810.0f, -1400.0f}},
    {ACTOR_17A_RBB_SPINNING_FLAT_PLATFORM_3, {1600.0f,  730.0f, -700.0f}, 270.0f, 5.0f, {  1600.0f,  810.0f, -1400.0f}},
    0
};
