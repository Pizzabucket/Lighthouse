...
void LighthouseInputEditorWindow::UpdateElement() {
...
void LighthouseInputEditorWindow::DrawAnalogPreview(const char* label, ImVec2 stick, float deadzone, bool gyro) {
...
void LighthouseInputEditorWindow::DrawInputChip(const char* buttonName, ImVec4 color = CHIP_COLOR_N64_GREY) {
    ImGui::BeginDisabled();
...
void LighthouseInputEditorWindow::DrawStickSection(uint8_t port, uint8_t stick, ImVec4 color = CHIP_COLOR_N64_GREY) {
    static int8_t sX, sY;
...
void LighthouseInputEditorWindow::UpdateBitmaskToMappingIds(uint8_t port) {
...
void LighthouseInputEditorWindow::UpdateStickDirectionToMappingIds(uint8_t port) {
...
void LighthouseInputEditorWindow::DrawRemoveRumbleMappingButton(uint8_t port, std::string id) {
    ImGui::SameLine();
    ImGui::PushStyleVar(ImGuiStyleVar_ButtonTextAlign, ImVec2(1.0f, 0.5f));
...
void LighthouseInputEditorWindow::DrawAddRumbleMappingButton(uint8_t port) {
    ImGui::SameLine();
    ImGui::PushStyleVar(ImGuiStyleVar_ButtonTextAlign, ImVec2(1.0f, 0.5f));
...
bool LighthouseInputEditorWindow::TestingRumble() {
    return mRumbleTimer != INT32_MAX;
}

void LighthouseInputEditorWindow::DrawRumbleSection(uint8_t port) {
...
void LighthouseInputEditorWindow::DrawRemoveLEDMappingButton(uint8_t port, std::string id) {
    ImGui::SameLine();
    ImGui::PushStyleVar(ImGuiStyleVar_ButtonTextAlign, ImVec2(1.0f, 0.5f));
...
void LighthouseInputEditorWindow::DrawAddLEDMappingButton(uint8_t port) {
    ImGui::SameLine();
    ImGui::PushStyleVar(ImGuiStyleVar_ButtonTextAlign, ImVec2(1.0f, 0.5f));
...
void LighthouseInputEditorWindow::DrawLEDSection(uint8_t port) {
    for (auto [id, mapping] :
...
void LighthouseInputEditorWindow::DrawRemoveGyroMappingButton(uint8_t port, std::string id) {
    ImGui::SameLine();
    ImGui::PushStyleVar(ImGuiStyleVar_ButtonTextAlign, ImVec2(1.0f, 0.5f));
...
void LighthouseInputEditorWindow::DrawAddGyroMappingButton(uint8_t port) {
    ImGui::SameLine();
    ImGui::PushStyleVar(ImGuiStyleVar_ButtonTextAlign, ImVec2(1.0f, 0.5f));
...
void LighthouseInputEditorWindow::DrawGyroSection(uint8_t port) {
    auto mapping =
...
void LighthouseInputEditorWindow::addButtonName(N64ButtonMask mask, const char* name) {
...
void LighthouseInputEditorWindow::DrawDeviceToggles(uint8_t portIndex) {
    ImGui::PushItemFlag(ImGuiItemFlags_Disabled, true);
...
void LighthouseInputEditorWindow::DrawClearAllButton(uint8_t portIndex) {
...
void LighthouseInputEditorWindow::DrawSetDefaultsButton(uint8_t portIndex) {
    ImGui::SameLine();
...
void LighthouseInputEditorWindow::DrawFullContents() {
...
void LighthouseInputEditorWindow::DrawElement() {
    DrawFullContents();
}

void LighthouseInputEditorWindow::OffsetMappingPopup() {
