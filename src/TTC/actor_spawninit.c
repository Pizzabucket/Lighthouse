...
static void __code26D0_spawnLighthouseB(uintptr_t arg0){
...
static void __code26D0_lighthouseAUpdateFunc(Actor *this){
    ...
    if(!this->volatile_initialized){
        __spawnQueue_add_1((GenFunction_1)__code26D0_spawnLighthouseB, (uintptr_t)this->marker);
