...
/* .code */
static void __maCastle_transformMeshCallbackOverlayUpdate(s32 arg0, BKModelVtxRef *vtx_ref, Vtx *vtx, void *arg2)
{
    vtx->v.ob[1] += 2;
}

static void __maCastle_transformMeshCallbackOverlayInit(s32 arg0, BKModelVtxRef *vtx_ref, Vtx *vtx, void *arg2)
{
    vtx->v.ob[1] += 0xf0;
}
...
static void __maCastle_meshCallbackFloorTileState_1(s32 arg0, BKModelVtxRef *ref, Vtx *dst, void *arg3)
{
...
static void __maCastle_meshCallbackFloorTileState_3(s32 arg0, BKModelVtxRef *ref, Vtx *dst, void *arg3)
{
    LetterFloorTile *ptr = (LetterFloorTile *)arg3;
    f32 temp_f12;
...
static void __maCastle_meshCallbackFloorTileState_5(s32 arg0, BKModelVtxRef *ref, Vtx *dst, void *arg3)
{
    LetterFloorTile *ptr = (LetterFloorTile *)arg3;
    f32 temp_f2;
...
static void __maCastle_updateTimeDeltaSumForFloorTiles()
{
    ...
    for (floor_tile = sLetterFloorTiles; floor_tile->meshId != 0; floor_tile++)
    {
        ...
        {
            model_transformMesh(sMapState.model1, floor_tile->meshId, __maCastle_meshCallbackFloorTileState_1, (void *)floor_tile);
        }
        else if (floor_tile->state == 3)
        {
            model_transformMesh(sMapState.model1, floor_tile->meshId, __maCastle_meshCallbackFloorTileState_3, (void *)floor_tile);
        }
        else if (floor_tile->state == 5)
        {
            model_transformMesh(sMapState.model1, floor_tile->meshId, __maCastle_meshCallbackFloorTileState_5, (void *)floor_tile);
        }
    }
}
