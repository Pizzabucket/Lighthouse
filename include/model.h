...
typedef void (*bk_model_transform_func_s)(s32 mesh_id, BKModelVtxRef *vtx_ref, Vtx *vtx, void *arg3);

/* Function declarations
 *
 */

BKAnimVerticesList *modelbin_getAnimVerticesList(BKModelBin *self);
BkGeoType modelbin_getGeoType(BKModelBin *self);
BKGfxList *modelbin_getGfxList(BKModelBin *self);
BKCollisionList *modelbin_getCollisionList(BKModelBin *self);
BKMeshList *modelbin_getMeshList(BKModelBin *self);
f32 modelbin_getUnk34(BKModelBin *self);
BKAnimationList *modelbin_getAnimationList(BKModelBin *self);
BKTextureList *modelbin_getTextureList(BKModelBin *self);
BKAnimTextureList *modelbin_getAnimTextureList(BKModelBin *self);
BKModelUnk14List *modelbin_getUnk14List(BKModelBin *self);
BKVertexList *modelbin_getVtxList(BKModelBin *self);
BKCameraAreaList *modelbin_getCameraAreaList(BKModelBin *self);
...
s32 textureInfo_getPaletteSize(BKTextureInfo *self);
s32 textureInfo_getOffset(BKTextureInfo *self);
s32 textureInfo_getTextureSize(BKTextureInfo *self);

f32 core2_C3A40_getIntensity(f32 curve_values[4], f32 position);
void core2_C3A40_getDefaultValues(f32 dst[4]);

Vtx *vtxList_getVertices(BKVertexList *self);
void vtxList_getBounds_s32(BKVertexList *self, s32 min[3], s32 max[3]);
void vtxList_getBounds_f32(BKVertexList *self, f32 min[3], f32 max[3]);
...
void vtxList_getVtxRange(BKVertexList *self, Vtx **begin_ptr, Vtx **end_ptr);
s32 vtxList_getVtxCount(BKVertexList *self);
f32 vtxList_getGlobalNorm(BKVertexList *self);
void vtxList_getCenterAndNorm(BKVertexList *self, f32 center[3], f32 *norm);
f32 vtxList_getLocalNorm(BKVertexList *self);
void vtxList_free(BKVertexList *self);
BKVertexList *vtxList_clone(BKVertexList *self);
void vtxList_copyColorsFrom(BKVertexList *self, BKVertexList *src);
void vtxList_tintColorsFrom(BKVertexList *self, s32 target_color[3], f32 intensity, BKVertexList *src);
void vtxList_recolor(BKVertexList *self, s32 color[3]);
...
bool cameraAreaList_searchForEntryInBounds(BKCameraAreaList *self, u8 *id, u32 count);
void cameraAreaList_updateInBoundsFlag(BKCameraAreaList *self, f32 camera_position[3], f32 scale);
...
void model_transformMeshes(BKModel *self, bk_model_transform_func_s fn, void *transform_func_arg);
void model_transformMesh(BKModel *self, s32 mesh_id, bk_model_transform_func_s fn, void *transform_func_arg);
void model_getMeshCenter(BKModel *self, s32 mesh_id, s16 dst[3]);
BKMeshList *model_getMeshList(BKModel *self);
void model_getMeshCoordRange(BKModel *self, s32 mesh_id, s16 min[3], s16 max[3]);
s32 model_func_8033F3C0(BKModel *self, f32 position[3]);
s32 model_func_8033F3E8(BKModel *self, f32 position[3], s32 min_id, s32 max_id);
void model_free(BKModel *self);
